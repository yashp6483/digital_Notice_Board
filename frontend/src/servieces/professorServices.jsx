...
export const fetchProfessor = async () => {
    ...
    const res = await fetch(`/admin/professors`, {
        headers: {
...
export const deleteProfessor = async (id) => {
    ...
    const res = await fetch(`/admin/professor/delete/${id}`, {
        method: "DELETE",
        headers: {
            Authorization: `Bearer ${token}`,
        },
...
export const updateProfessor = async (id, formData) => {
    ...
    const res = await fetch(`/admin/professor/update/${id}`, {
        method: "PUT",
        headers: {
            Authorization: `Bearer ${token}`,
        },
...
export const getProfessorProfile = async () => {
    ...
    const res = await fetch("/admin/professor/profile", { headers });
    const data = await res.json();
...
export const updateProfessorProfile = async (formData) => {
    ...
    const res = await fetch("/admin/professor/profile", {
        method: "PUT",
        headers,
